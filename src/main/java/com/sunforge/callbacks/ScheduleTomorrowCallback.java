...
public class ScheduleTomorrowCallback {

    private static final LocalizationBundle localizationBundle = LocalizationBundle.getInstance();
    private static final Logger logger = LogManager.getLogger(ScheduleTomorrowCallback.class);

    public static void sendTomorrowDayScheduleMessage(Update passedUpdate) {
